...
# ==================== ТАБЛИЦА ЛИДЕРОВ (УЛУЧШЕННАЯ СТРУКТУРА) ====================
...
async def show_faq_category(q, ctx, category_name, questions):
    text = f"📚 **{category_name}**\n\n"
    kb = []
    for idx, q_text in enumerate(questions):
        # Сохраняем индекс вопроса для callback
